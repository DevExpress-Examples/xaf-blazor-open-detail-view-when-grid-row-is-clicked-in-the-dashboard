<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/434202214/24.2.3%2B)
...
<!-- default badges end -->
# XAF - Open a Detail View When a Grid Row is Clicked in the Dashboard (Blazor)
