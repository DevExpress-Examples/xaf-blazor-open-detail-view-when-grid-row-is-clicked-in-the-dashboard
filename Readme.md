<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/434202214/25.2.1%2B)
...
<!-- default badges end -->
# XAF - Open a Detail View When a Grid Row is Clicked in the Dashboard
...
* [Open a Detail View When the Grid Row is Clicked in the Dashboard (WinForms)](https://docs.devexpress.com/eXpressAppFramework/118348/analytics/dashboards/open-a-detail-view-when-the-grid-row-is-clicked-in-the-dashboard-winforms-web-forms)
...
- [WinShowDetailViewFromDashboardController.cs](CS/EF/OpenViewFromDashboardEF/OpenViewFromDashboardEF.Win/Controllers/WinShowDetailViewFromDashboardController.cs)
