...
namespace ShowDetailViewFromDashboard.Blazor.Server {
    public partial class ShowDetailViewFromDashboardBlazorApplication : BlazorApplication {
        public ShowDetailViewFromDashboardBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void ShowDetailViewFromDashboardBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
